...
import com.isaiahvonrundstedt.bucket.features.support.FrameActivity
...
class NotificationService: BaseService() {
    ...
    companion object {
        private const val actionPath = "com.isaiahvonrundstedt.bucket.features.shared.receivers.RestartReceiver"
