package com.isaiahvonrundstedt.bucket.experience.activities.support
...
import com.isaiahvonrundstedt.bucket.core.adapters.VaultAdapter
...
import com.isaiahvonrundstedt.bucket.core.constants.Parameters
                ...
                .addOnCompleteListener { task ->
                    if (task.isSuccessful){
                        for (queryDocumentSnapshot: QueryDocumentSnapshot in task.result!!){
                            ...
                            file.id = queryDocumentSnapshot.id
                            itemList.add(file)
                        }
