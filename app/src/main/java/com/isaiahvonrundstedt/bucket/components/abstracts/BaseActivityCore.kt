...
abstract class BaseActivityCore: AppCompatActivity() {
    ...
    private fun setInterface() {
        ...
        if (rootView != null){
            val layoutID: Int? = when (Preferences(this).theme){
                Preferences.THEME_LIGHT -> R.layout.layout_appbar_light_main
                Preferences.THEME_DARK -> R.layout.layout_appbar_dark_main
                Preferences.THEME_AMOLED -> R.layout.layout_appbar_amoled_main
                else -> null
            }
